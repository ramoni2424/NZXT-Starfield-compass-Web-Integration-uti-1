...
//imagenes
/*
let element = document.getElementById('img'); // Reemplaza 'myElement' con el ID de tu elemento

setInterval(() => {
  let randomNum = Math.random();
  let newImage = new Image();
  newImage.src = `https://picsum.photos/670/620?random=${randomNum}`;
  newImage.onload = () => {
    element.style.backgroundImage = `url('${newImage.src}')`;
    
    // preg a chat gpt como hacerlo
        //element.src='src=`https://picsum.photos/200/300?random=${randomNum}`;

  };
}, 2000); //60000
*/
/*
let element = document.querySelector('#imagen1 img'); // Selecciona la imagen dentro del div con el ID 'imagen1'
